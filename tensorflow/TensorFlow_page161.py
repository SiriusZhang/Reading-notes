...
MODEL_DIR = './model/page161'
MODEL_FILE = 'tensorflow_inception_graph.pb'

CACHE_DIR = './model/tmp/bottleneck'
	...
	with tf.Session() as sess:
		...
		for i in range(STEPS):
			...
			if i%100 == 0 or i + 1 == STEPS:
				validation_bottlenecks, validation_ground_truth = get_random_cached_bottlenecks(sess, n_classes, image_lists, BATCH,
