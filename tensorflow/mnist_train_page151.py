...
import TensorFlow_page151 as mnist_inference
...
def train(mnist):
	x = tf.placeholder(tf.float32, 
		[BATHC_SIZE, mnist_inference.IMAGE_SIZE, mnist_inference.IMAGE_SIZE, mnist_inference.NUM_CHANNELS], 
		name = 'x-input')
	...
	with tf.Session() as sess:
		...
		for i in range(TRAINING_STEPS):
			...
			reshaped_xs = np.reshape(xs, (BATHC_SIZE, mnist_inference.IMAGE_SIZE, mnist_inference.IMAGE_SIZE, mnist_inference.NUM_CHANNELS))
